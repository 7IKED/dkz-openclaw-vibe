...
![Lines](https://img.shields.io/badge/Lines-797-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-openclaw-vibe.git

# Oeffnen
cd dkz-openclaw-vibe
